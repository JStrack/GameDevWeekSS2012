...
/**
 * Menu page: Join Server
 * 
 * @author Lusito
 * @todo file paths need to be adapted when resource loader is ready.
 */
public class MenuPageJoin extends MenuPage {
	public MenuPageJoin(final GameContainer container, final StateBasedGame game, final MainMenuState menuState, MenuPage parent)
